...
2.  ```{chartjs} template:chart
    ...
    options: {
      ...
      borderWidth: 1, borderColor: 'black', backgroundColor: '#0005',
      scales: {
        y: {beginAtZero: true, title: {display: true, text: 'Moyen de transport'}},
        x: {title: {display: true, text: 'Effectif'}},
      },
      plugins: {
        legend: {display: false},
        title: {display: true, text: 'Répartition des élèves en fonction de leur moyen de transport'},
      },
    },
    ```
...
2.  ```{chartjs} template:chart
    ...
    options: {
      ...
      borderWidth: 1, borderColor: 'black', backgroundColor: '#0005',
      scales: {
        y: {beginAtZero: true, title: {display: true, text: 'Groupe sanguin'}},
        x: {title: {display: true, text: 'Effectif'}},
      },
      plugins: {
        legend: {display: false},
        title: {display: true, text: 'Répartition en fonction de leur groupe sanguin'},
      },
    },
    ```
````
...
4.  $ $
    ...
    \end{array}
    ```
5.  Fonction de répartition des fréquences cumulées:
    ```{jsxgraph} template:discrete-cumulative-distribution
    :style: aspect-ratio: 2 / 1; width: 80%;
    board: {defaults: 'print'},
    samples: [3, 3.5, 4, 3, 5, 6, 6, 4, 4.5, 5, 5, 3, 2.5, 3, 5, 6, 5.5, 4.5, 2,
     2.5, 3.5, 4, 4, 4, 4.5, 5.5, 4, 5, 3, 5],
    ```
````
...
5.  ```{chartjs} template:chart
    ...
    options: {
      ...
      plugins: {
        legend: {display: false},
        title: {display: true, text: "Répartition des élèves en fonction de leur pointure"},
      },
    },
    ```
  6.  Fonction de répartition des fréquences cumulées:
      ```{jsxgraph} template:discrete-cumulative-distribution
      :style: aspect-ratio: 2 / 1; width: 80%;
      board: {defaults: 'print'},
      samples: [32, 32, 32, 33, 33, 33, 33, 33, 34, 34, 34, 34, 34, 34, 34,
      35, 35, 35, 35, 35, 35, 35, 35, 35, 35, 36, 36, 36, 36, 36, 36 ,36, 36, 36,
      37, 37, 37, 37, 37, 37, 37, 37, 37, 37, 37, 37, 37, 37, 38, 38, 38, 38, 38,
      38, 38, 38, 38, 38, 38, 38, 38, 38, 38, 38, 39, 39, 39, 39, 39, 39,  39,
      39, 39, 39, 39, 39, 40, 40, 40, 40, 40, 40, 40, 41, 41],
      ```
````
